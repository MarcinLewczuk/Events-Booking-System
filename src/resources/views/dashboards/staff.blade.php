...
<x-layouts.app>
    <div class="min-h-screen bg-gray-50 py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <!-- Header -->
            <div class="bg-gradient-to-r from-primary-900 to-primary-800 shadow-xl p-6 mb-8">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div class="mt-4 sm:mt-0">
                        @switch($role)
                            @case('admin')
                                <span class="inline-flex items-center px-4 py-2 bg-white/20 text-white font-semibold">
                        ...
                        @foreach($upcomingAuctions as $date => $auctions)
                            @if($date !== 'no-date')
                                @foreach($auctions as $auction)
                                    <div class="bg-white shadow-lg hover:shadow-xl transition-all overflow-hidden border-t-4 border-primary-600">
                                        <!-- Date Header -->
                                        ...
                                        <div class="p-4">
                                            ...
                                            class="mt-4 w-full inline-flex items-center justify-center px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white font-semibold transition">
                                                View Details
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8 mt-3">
                <!-- Events -->
                <div class="bg-white shadow-lg p-6 border-l-4 border-primary-600 hover:shadow-xl transition">
                    <div class="flex items-center justify-between">
                        <div>
                ...
                <!-- Categories -->
                <div class="bg-white shadow-lg p-6 border-l-4 border-secondary-600 hover:shadow-xl transition">
                    <div class="flex items-center justify-between">
                        <div>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <!-- Events -->
                    <a href="{{ route('admin.events.index') }}" class="group bg-white shadow-lg hover:shadow-xl p-6 transition-all border-l-4 border-primary-600 transform hover:-translate-y-1">
                        <div class="flex items-center justify-between mb-3">
                            <div class="bg-primary-100 p-3 group-hover:bg-primary-200 transition flex items-center justify-center">
                    ...
                    @if($role === 'admin')
                        <!-- Categories -->
                        <a href="{{ route('admin.categories.index') }}" class="group bg-white shadow-lg hover:shadow-xl p-6 transition-all border-l-4 border-secondary-600 transform hover:-translate-y-1">
                            <div class="flex items-center justify-between mb-3">
                                <div class="bg-red-100 p-3 group-hover:bg-red-200 transition flex items-center justify-center">
                                    <span class="text-2xl">📁</span>
                                </div>
                        ...
                        <!-- Tags -->
                        <a href="{{ route('admin.tags.index') }}" class="group bg-white shadow-lg hover:shadow-xl p-6 transition-all border-l-4 border-primary-600 transform hover:-translate-y-1">
                            <div class="flex items-center justify-between mb-3">
                                <div class="bg-primary-100 p-3 group-hover:bg-primary-200 transition flex items-center justify-center">
                        ...
                        <!-- Users -->
                        <a href="{{ route('admin.users.index') }}" class="group bg-white shadow-lg hover:shadow-xl p-6 transition-all border-l-4 border-secondary-600 transform hover:-translate-y-1">
                            <div class="flex items-center justify-between mb-3">
                                <div class="bg-red-100 p-3 group-hover:bg-red-200 transition flex items-center justify-center">
                                    <span class="text-2xl">👥</span>
                                </div>
                        ...
                        <!-- Announcements -->
                        <a href="{{ route('admin.announcements.index') }}" class="group bg-white shadow-lg hover:shadow-xl p-6 transition-all border-l-4 border-primary-600 transform hover:-translate-y-1">
                            <div class="flex items-center justify-between mb-3">
                                <div class="bg-primary-100 p-3 group-hover:bg-primary-200 transition flex items-center justify-center">
                                    <span class="text-2xl">📢</span>
                                </div>
