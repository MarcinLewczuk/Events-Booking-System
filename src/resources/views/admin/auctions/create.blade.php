<x-app-layout>
    <div class="py-8 px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto">
            <!-- Header -->
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-gray-900">Create New Auction</h1>
                <p class="mt-1 text-sm text-gray-600">Schedule a new auction event</p>
            </div>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="mb-6">
                                ...
                                <input type="text" 
                                       name="title" 
                                       value="{{ old('title') }}"
                                       placeholder="e.g., Spring 2026 Fine Art & Antiques Auction"
                            ...
                            <div class="mb-6">
                                ...
                                <select name="catalogue_id"
                                    ...
                                    @forelse($catalogues as $c)
                                        <option value="{{ $c->id }}" {{ old('catalogue_id') == $c->id ? 'selected' : '' }}>
                                            {{ $c->name }} ({{ $c->items()->count() }} items)
                                        </option>
                                    @empty
                                        <option value="" disabled>
                                            No available catalogues (all published catalogues already have auctions)
                                        </option>
                                    @endforelse
                                </select>
                                ...
                                <p class="mt-2 text-sm text-gray-600">
                                    ...
                                    Only published catalogues without an auction can be selected
                                </p>
                            </div>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" 
                                           name="auction_block" 
                                           value="{{ old('auction_block') }}"
                                           placeholder="e.g., Block A, Main Hall"
                                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-600 focus:border-transparent transition">
                                    <p class="mt-1 text-xs text-gray-600">Optional grouping identifier</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                            <div class="flex items-start">
                                ...
                                <div class="text-sm text-blue-800">
                                    ...
                                    <p>After creating the auction, you can manage lot numbers, add customers, and track bids from the auction details page.</p>
                                </div>
                            </div>
                        </div>
                        <!-- Approval Status Section -->
                        <div class="mb-8">
                            <h3 class="text-lg font-semibold text-gray-900 mb-4 pb-2 border-b border-gray-200">Approval Status</h3>
                            ...
                            <div class="mb-6">
                                ...
                                <select name="approval_status" 
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-600 focus:border-transparent transition">
                                    <option value="draft" {{ old('approval_status', 'draft') == 'draft' ? 'selected' : '' }}>
                                        Draft (Save without submitting for approval)
                                    </option>
                                    <option value="awaiting_approval" {{ old('approval_status') == 'awaiting_approval' ? 'selected' : '' }}>
                                        Submit for Approval
                                    </option>
                                </select>
                                <p class="mt-2 text-sm text-gray-600">
                                    Choose "Submit for Approval" to send this auction to approvers for review
                                </p>
                            </div>
                        </div>
                        <!-- Actions -->
