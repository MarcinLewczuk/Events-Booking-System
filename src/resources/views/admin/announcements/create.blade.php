                    ...
                    <div class="border-l-4 border-[#370671] p-6">
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <!-- Auction Selection (hidden by default) -->
                                <div id="auction-field" style="display: {{ old('topic') == 'auction' ? 'block' : 'none' }};">
                                    <label class="block text-sm font-semibold text-gray-700 mb-2">
                                    ...
                                    <button type="button" 
                                        ...
                                        <span id="generate-btn-text">Auto-Generate Message</span>
                                    </button>
                                    <p class="mt-2 text-sm text-gray-600">
                                        Automatically generates a detailed announcement with auction information and featured items
                                    </p>
                                </div>

                                <!-- Catalogue Selection (hidden by default) -->
                                <div id="catalogue-field" style="display: {{ old('topic') == 'catalogue' ? 'block' : 'none' }};">
                                    <label class="block text-sm font-semibold text-gray-700 mb-2">
