    ...
    <div class="py-8 px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-8">
                ...
                <p class="mt-1 text-sm text-gray-600">Create announcements for events or send to all users</p>
            </div>
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="title" value="{{ old('title') }}"
                                           ...
                                           placeholder="e.g., New Event Announced, Schedule Change" required>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p class="mt-2 text-sm text-gray-600">
                                        Choose "General" to send to all users, or "Event-Specific" to link to a particular event
                                    </p>
                                </div>
                                ...
                                <div id="event-field" style="display: {{ old('topic') == 'event' ? 'block' : 'none' }};">
                                    ...
                                    <p class="mt-2 text-sm text-gray-600">
                                        Automatically generates a detailed announcement with event information, pricing, and availability
                                    </p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea name="message" id="message-textarea" rows="12"
                                              ...
                                              placeholder="Enter the announcement message or select an event above to auto-generate..."
                                              required>{{ old('message') }}</textarea>
                                    <p class="mt-2 text-sm text-gray-600">
                                        For event announcements, select an event first then use "Auto-Generate Message" to pre-fill this field
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="text-sm text-blue-800">
                                    ...
                                    <ul class="list-disc list-inside space-y-1">
                                        <li><strong>General:</strong> Sent to all users, not linked to any specific event</li>
                                        <li><strong>Event-Specific:</strong> Linked to a particular event for targeted communication</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
