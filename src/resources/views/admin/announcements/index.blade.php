        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 mb-6 border-l-4 border-primary-900">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-600">Manage auction and catalogue announcements</p>
                    </div>
            ...
            <div class="mb-6 bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                <form method="GET" action="{{ route('admin.announcements.index') }}" class="flex flex-col sm:flex-row gap-3">
                    ...
                    <select name="topic" class="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#370671] focus:border-transparent">
                        <option value="">All Topics</option>
                        <option value="auction" {{ request('topic') == 'auction' ? 'selected' : '' }}>Auctions</option>
                        <option value="catalogue" {{ request('topic') == 'catalogue' ? 'selected' : '' }}>Catalogues</option>
                    </select>
                    ...
                    @if(request('search') || request('topic'))
                        <a href="{{ route('admin.announcements.index') }}" class="px-4 py-2 bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold rounded-lg transition">
                            Clear
                        </a>
                    @endif
                </form>
