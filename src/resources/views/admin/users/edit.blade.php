                        ...
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600">
                                    {{ $user->email }} · 
                                    <span class="font-medium text-[#370671]">{{ ucfirst($user->role) }}</span>
                                    @if($user->id === auth()->id())
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                                <div>
                                    ...
                                    <p class="mt-1 text-xs text-gray-600">Leave blank to keep current password</p>
                                </div>
                                <div>
                                    <label class="block text-sm font-semibold text-gray-700 mb-2">
                            ...
                            <div class="mb-4">
                                ...
                                @if($user->id === auth()->id())
                                    <p class="mt-1 text-xs text-red-600">You cannot change your own role</p>
                            ...
                            @if($user->role === 'customer')
                                <div class="flex items-center p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                                    <input type="checkbox" 
                                           name="buyer_approved_status" 
                                           value="1"
                                           {{ old('buyer_approved_status', $user->buyer_approved_status) ? 'checked' : '' }}
                                           class="w-4 h-4 text-[#370671] border-gray-300 rounded focus:ring-[#370671]">
                                    <label class="ml-3 text-sm font-medium text-gray-900">
                                        Approve as buyer
                                        <span class="block text-xs text-gray-600 font-normal">Allow this customer to bid in auctions</span>
                                    </label>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('contact_telephone_number', $user->contact_telephone_number) }}"
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="contact_address" 
                                          rows="3" 
                                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#370671] focus:border-transparent transition">{{ old('contact_address', $user->contact_address) }}</textarea>
                            </div>
                        </div>
