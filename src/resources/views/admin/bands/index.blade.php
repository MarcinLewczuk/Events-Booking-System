        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 mb-6 border-l-4 border-primary-600">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                        <h1 class="text-3xl font-bold text-primary-900">Price Bands Management</h1>
                        <p class="text-gray-600 mt-1">Manage price ranges and approval requirements</p>
                    </div>
                    <x-buttons.link :href="route('admin.bands.create')">
                    ...
                    <table class="w-full">
                        <thead class="bg-gradient-to-r from-primary-900 to-primary-800 text-white">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-center text-sm font-bold uppercase tracking-wider">Items Count</th>
                        ...
                        <tbody class="divide-y divide-gray-200">
                            @forelse($bands as $band)
                                <tr class="hover:bg-primary-50 transition">
                                    <td class="px-6 py-4">
                                        <div class="text-sm font-bold text-gray-900">{{ $band->name }}</div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="text-sm font-semibold text-primary-900">
                                            £{{ number_format($band->min_price, 2) }}
                                            @if($band->max_price)
                                                - £{{ number_format($band->max_price, 2) }}
                                            @else
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-700">
                                        {{ Str::limit($band->description, 50) ?? 'N/A' }}
                                    </td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="px-6 py-12 text-center">
                                        ...
                                        <p class="mt-4 text-lg font-semibold text-gray-900">No bands found</p>
                                        <p class="mt-2 text-sm text-gray-600">Create your first price band</p>
                                        <div class="mt-6">
                                            <x-buttons.link :href="route('admin.bands.create')">
                                                Create New Band
                                            </x-buttons.link>
