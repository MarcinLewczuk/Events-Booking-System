    ...
    <div class="py-8 bg-gradient-to-br from-primary-50 to-secondary-50 min-h-screen">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-lg shadow-lg overflow-hidden border-l-4 border-indigo-600">
                <div class="p-6">
                    <div class="mb-6">
                        <h1 class="text-2xl font-bold text-primary-900">Create New Price Band</h1>
                        <p class="text-gray-600 mt-1">Define a new price range for items</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('admin.bands.store') }}" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   name="name" 
                                   value="{{ old('name') }}"
                                   placeholder="e.g., Low Value, Medium Value, High Value"
                        ...
                        <div>
                            ...
                            <textarea name="description" 
                                      rows="3"
                                      placeholder="Optional description for this price band"
                                      class="w-full rounded-lg border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500">{{ old('description') }}</textarea>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-2">
                                    Maximum Price (£) <span class="text-gray-500 text-xs">(Optional - leave empty for unlimited)</span>
                                </label>
                                <input type="number" 
                                       name="max_price" 
                                       value="{{ old('max_price') }}"
