                        ...
                        <tbody class="divide-y divide-gray-200">
                            @forelse($tags as $tag)
                                <tr class="hover:bg-purple-50 transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-4">
                                        <code class="px-2 py-1 bg-gray-100 text-gray-700 rounded text-sm">{{ $tag->slug }}</code>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium
                                            {{ $tag->items_count > 0 ? 'bg-purple-100 text-purple-800' : 'bg-gray-100 text-gray-600' }}">
                                            {{ $tag->items_count }}
                                        </span>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex items-center justify-center gap-2">
                                            <x-buttons.link href="{{ route('admin.tags.edit', $tag) }}">
                                                Edit
                                            </x-buttons.link>
                                            <form method="POST" 
