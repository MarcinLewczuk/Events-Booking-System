    ...
    <div class="py-8 bg-gradient-to-br from-primary-50 to-secondary-50 min-h-screen">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-lg shadow-lg overflow-hidden border-l-4 border-purple-600">
                <div class="p-6">
                    <div class="mb-6">
                        <h1 class="text-2xl font-bold text-primary-900">Create New Category</h1>
                        <p class="text-gray-600 mt-1">Add a new category or subcategory</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('admin.categories.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600 mt-1">Select a parent to create a subcategory</p>
                        </div>
