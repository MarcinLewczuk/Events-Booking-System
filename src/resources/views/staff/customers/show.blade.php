                    ...
                    <div class="flex items-center">
                        <div class="flex-shrink-0 h-16 w-16 bg-primary-100 rounded-full flex items-center justify-center">
                            <span class="text-primary-700 font-bold text-xl">
                                {{ substr($user->first_name, 0, 1) }}{{ substr($user->surname, 0, 1) }}
                            </span>
                        </div>
                        <div class="ml-4">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        @if(auth()->user()->role === 'admin')
                            <a href="{{ route('admin.users.edit', $user) }}" 
                               class="inline-flex items-center px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white rounded-lg font-medium transition">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-1 gap-6">
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-900">{{ $user->contact_telephone_number ?? 'Not provided' }}</p>
                            </div>

                            <div>
                                <label class="text-sm font-medium text-gray-500">Address</label>
                                <p class="mt-1 text-sm text-gray-900">{{ $user->contact_address ?? 'Not provided' }}</p>
                            </div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                        <h2 class="text-lg font-semibold text-gray-900 mb-4">Interested Tags</h2>
                        
                        @if($user->interestedTags->isEmpty())
