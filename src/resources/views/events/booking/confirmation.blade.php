        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div class="bg-white rounded-2xl shadow-2xl overflow-hidden mb-8">
                ...
                <div class="bg-gradient-to-r from-green-500 to-green-600 text-white px-8 py-12 text-center">
                    ...
                    <h1 class="text-4xl md:text-5xl font-bold mb-3">Booking Confirmed!</h1>
                    <p class="text-xl text-green-50">Your spot is reserved</p>
                </div>
                ...
                <div class="px-8 py-8 space-y-6">
                    ...
                    <div class="bg-gradient-to-r from-secondary-100 to-secondary-50 border-2 border-secondary-300 rounded-xl p-6 text-center">
                        ...
                        <p class="text-3xl font-bold font-mono text-gray-900 tracking-wide">{{ $booking->booking_reference }}</p>
                        <p class="text-sm text-gray-600 mt-2">Please save this reference number</p>
                    </div>

                    <!-- Event Title -->
                    <div>
                        <h2 class="text-3xl font-bold text-gray-900 mb-2">{{ $booking->event->title }}</h2>
                    </div>

                    <!-- Event Date & Time -->
                    <div class="flex items-start border-l-4 border-teal-light-500 pl-4 py-2">
                        <svg class="w-6 h-6 text-teal-light-500 mr-3 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                        </svg>
                        <div>
                            <p class="font-bold text-gray-900 text-lg">{{ $booking->event->start_datetime->format('l, j F Y') }}</p>
